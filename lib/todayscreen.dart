import 'dart:async';
import 'package:time_tracking_app/model/user.dart';
...
class _TodayScreenState extends State<TodayScreen> {
  ...
  void _getOfficeCode() async {
    ...
    if (snap.exists) {
      ...
      // Check if the 'code' field exists in the document data
      if (data.containsKey('code')) {
        // If the field exists, set the state
        setState(() {
          officeCode = data['code'];
        });
      } else {
        // Handle the case where the 'code' field does not exist
        print("The 'code' field does not exist in the document.");
      }
    } else {
                      ...
                      return SlideAction(
                        ...
                        onSubmit: () async {
                          ...
                          if (User.lat != 0) {
                            ...
                            try {
                              DocumentSnapshot?
                                  snap2; // Note the '?' to make it nullable
                              ...
                              if (snap.docs.isNotEmpty) {
                                ...
                                // Handle the case where snap.docs is empty
